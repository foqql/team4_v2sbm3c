...
public class SMSCont {
  ...
  public String form(HttpSession session) {
    ...
    return "/th/sms/form";  // /templates/th/sms/form.html
  }
  ...
  public ModelAndView proc(HttpSession session, HttpServletRequest request) {
    ...
    mav.setViewName("/th/sms/proc");  // /WEB-INF/views/sms/proc.jsp
  ...
  public String confirm(Model model, HttpSession session, @RequestParam("auth_no") String auth_no) {
      String session_auth_no = (String)session.getAttribute("auth_no"); // 사용자에게 전송된 번호 session에서 꺼냄
      
      String msg="";
      
      if (session_auth_no != null && session_auth_no.equals(auth_no)) {
