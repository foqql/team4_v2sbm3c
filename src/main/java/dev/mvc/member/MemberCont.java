...
import dev.mvc.musical.MusicalProcInter;
import dev.mvc.musical.MusicalVOMenu;
...
public class MemberCont {
  ...
  @Autowired
  @Qualifier("dev.mvc.musical.MusicalProc")
  private MusicalProcInter musicalProc;
  ...
  public String create_form(Model model, @ModelAttribute("memberVO") MemberVO memberVO) {
    ArrayList<MusicalVOMenu> menu = this.musicalProc.menu();
