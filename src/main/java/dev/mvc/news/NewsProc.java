...
public class NewsProc implements NewsProcInter {
  ...
  public int create(NewsVO newsVO) {
    // -------------------------------------------------------------------
    String passwd = newsVO.getPasswd();
    String passwd_encoded = this.security.aesEncode(passwd);
    newsVO.setPasswd(passwd_encoded);
    // -------------------------------------------------------------------
  ...
  public ArrayList<NewsVO> list_by_classifyno(int classifyno) {
    ArrayList<NewsVO> list = this.newsDAO.list_by_classifyno(classifyno);
    return list;
  }
  ...
  public int list_by_classifyno_search_count(HashMap<String, Object> hashMap) {
    int cnt = this.newsDAO.list_by_classifyno_search_count(hashMap);
    return cnt;
  }
  ...
  public ArrayList<NewsVO> list_by_classifyno_search_paging(HashMap<String, Object> map) {
    ...
    ArrayList<NewsVO> list = this.newsDAO.list_by_classifyno_search_paging(map);
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
  ...
  public int password_check(HashMap<String, Object> map) {
    ...
    int cnt = this.newsDAO.password_check(map);
    return cnt;
  }

  @Override
  public int update_text(NewsVO newsVO) {
    int cnt = this.newsDAO.update_text(newsVO);
    return cnt;
  }

  @Override
  public int update_file(NewsVO newsVO) {
    int cnt = this.newsDAO.update_file(newsVO);
    return cnt;
  }
  ...
  public int count_by_classifyno(int classifyno) {
    int cnt = this.newsDAO.count_by_classifyno(classifyno);
    return cnt;
  }

  @Override
  public int delete_by_classifyno(int classifyno) {
    int cnt = this.newsDAO.delete_by_classifyno(classifyno);
    return cnt;
  }

  @Override
  public int count_by_memberno(int memberno) {
    int cnt = this.newsDAO.count_by_memberno(memberno);
    return cnt;
  }

  @Override
  public int delete_by_memberno(int memberno) {
    int cnt = this.newsDAO.delete_by_memberno(memberno);
    return cnt;
  }

  @Override
  public int increaseReplycnt(int newsno) {
    int count = newsDAO.increaseReplycnt(newsno);
    return count;
  }
...
//  }
  ...
  public int increaseRecom(int newsrecomno) {
    int cnt = this.newsDAO.increaseRecom(newsrecomno);
    return cnt;
  }
